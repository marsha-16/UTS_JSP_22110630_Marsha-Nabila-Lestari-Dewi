...
<%
    ...
    // Tentukan URL gambar berdasarkan judul film
    String posterUrl = "";
    if (film != null) {
        if (film.equalsIgnoreCase("Film Petualang Sherina")) {
            posterUrl = "https://www.lavanguardia.com/peliculas-series/images/movie/poster/2000/6/w1280/utB3KW8nFGqjyjnYPvF7gtb9Heu.jpg";
        } else if (film.equalsIgnoreCase("Film Home Sweet Loan")) {
            posterUrl = "https://i.pinimg.com/originals/59/a1/0d/59a10d78e021f5ecbafe1d51e7d9141d.jpg";
        } else if (film.equalsIgnoreCase("Film Gampang Cuan")) {
            posterUrl = "https://images.justwatch.com/poster/309465994/s718/gampang-cuan.jpg";
        }
    }
%>
...
<body>
    <div class="ticket-container">
        ...
        <% if (!posterUrl.isEmpty()) { %>
            <img src="<%= posterUrl %>" alt="Poster Film" class="img-fluid rounded mb-3" style="max-height: 300px;" />
        <% } %>
