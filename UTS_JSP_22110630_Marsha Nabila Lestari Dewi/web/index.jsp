    ...
    <div class="container mt-5">
        ...
        <div class="row">
            <%
                ...
                films.add(new String[]{"Film Petualangan Sherina", "Petualangan", "120 menit", "50000", "10:00, 13:00, 16:00","https://www.lavanguardia.com/peliculas-series/images/movie/poster/2000/6/w1280/utB3KW8nFGqjyjnYPvF7gtb9Heu.jpg"});
                films.add(new String[]{"Film Home Sweet Loan", "Drama Cinta", "90 menit", "40000", "11:00, 14:00, 17:00", "https://i.pinimg.com/originals/59/a1/0d/59a10d78e021f5ecbafe1d51e7d9141d.jpg"});
                films.add(new String[]{"Film Gampang Cuan", "Komedi Lucu", "100 menit", "45000", "12:00, 15:00, 18:00","https://images.justwatch.com/poster/309465994/s718/gampang-cuan.jpg"});
            ...
            <div class="col-md-4 mb-4">
                <div class="film-card animate__animated animate__fadeInUp" style="animation-delay: <%= animationDelay %>;">
                    ...
                    <div class="film-card-body film-info text-center">
                        <!-- Tambahkan gambar -->
                        <img src="<%= film[5] %>" alt="<%= film[0] %>" class="img-fluid mb-3 rounded" style="max-height: 300px; object-fit: cover;" />
