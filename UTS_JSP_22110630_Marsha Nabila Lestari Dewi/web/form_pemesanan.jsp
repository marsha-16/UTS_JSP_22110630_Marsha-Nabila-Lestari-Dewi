...
<%
    ...
    films.add(new String[]{"Film Petualang Sherina", "10:00,13:00,16:00", "https://www.lavanguardia.com/peliculas-series/images/movie/poster/2000/6/w1280/utB3KW8nFGqjyjnYPvF7gtb9Heu.jpg"});
    films.add(new String[]{"Film Home Sweet Loan", "11:00,14:00,17:00", "https://i.pinimg.com/originals/59/a1/0d/59a10d78e021f5ecbafe1d51e7d9141d.jpg"});
    films.add(new String[]{"Film Gampang Cuan", "12:00,15:00,18:00", "https://images.justwatch.com/poster/309465994/s718/gampang-cuan.jpg"});
...
<div class="container">
    <div class="form-container">
        ...
        <% if (!gambarFilm.isEmpty()) { %>
            <img src="<%= gambarFilm %>" alt="Poster Film" class="poster"/>
        <% } %>
